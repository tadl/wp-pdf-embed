...
* Improve Avada's PDF selection preview and place document controls in the General tab.
* Prevent Avada theme styles from stretching the viewer's page-number field.
